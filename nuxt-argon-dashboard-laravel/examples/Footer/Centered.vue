      ...
      <div class="row">
        <div class="mx-auto mt-1 text-center col-8">
          <p class="mb-0 text-secondary">
            Copyright © {{ new Date().getFullYear() }} Soft by <a href="https://www.creative-tim.com/" target="_blank">Creative Tim</a> and <a href="https://updivision.com/" target="_blank">UPDIVISION</a>.
          </p>
        </div>
      </div>
    </div>
